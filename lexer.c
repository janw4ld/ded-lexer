...
"alignof", "and", "and_eq", "asm", "atomic_cancel", "atomic_commit",
...
"or_eq", "private", "protected", "public", "reflexpr", "reinterpret_cast",
"requires", "static_assert", "static_cast", "synchronized", "template", "this",
